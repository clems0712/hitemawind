    ...
    <div class="page-wrapper">1
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li onclick="document.getElementById('button').value = 'employe'; document.getElementById('valid').submit();" style="cursor:pointer">
                            <a>
                                <i class="fas fa-desktop"></i>Employés</a>
                        </li>
                        <li  class="active has-sub" onclick="document.getElementById('button').value = 'facture'; document.getElementById('valid').submit();" style="cursor:pointer">
                            <a>
        ...
        <div class="page-container">
            ...
            <div class="main-content">
               ...
               <tbody>
           <c:forEach var="employe" items="${data}">
               <tr>
                   <td>${employe.getInvoiceDate()}</td>
                   <td>${employe.getTax()}</td>
                   <td>${employe.getShipping()}</td>
                   <td>${employe.getAmountDue()}</td>
                   <td>${employe.getOrderId().getShipName()}</td>
               </tr>
           </c:forEach>
               </tbody>
           </table>
