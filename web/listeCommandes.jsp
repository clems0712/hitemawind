    ...
    <div class="page-wrapper">1
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li  class="active has-sub" onclick="document.getElementById('button').value = 'commande'; document.getElementById('valid').submit();" style="cursor:pointer">
                            <a>
        ...
        <div class="page-container">
           ...
           <c:forEach var="data" items="${data}">
               <tr>
                   <td>${data.getId()}</td>
                   <td>${data.getEmployeeId().getLastName()} - ${data.getEmployeeId().getFirstName()}</td>
